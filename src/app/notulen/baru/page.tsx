            ...
            <div style={{ padding: '4rem', display: 'flex', flexDirection: 'column', gap: '3.5rem' }}>
               ...
               {aiResult?.insights && aiResult.insights.length > 0 && (
                 <section>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '2rem' }}>
                      <div style={{ width: '8px', height: '24px', backgroundColor: 'var(--primary)', borderRadius: '4px' }} />
                      <h3 style={{ fontSize: '1.25rem', fontWeight: 800 }}>III. INSIGHTS & REKOMENDASI</h3>
                    </div>
                    
                    <div style={{ paddingLeft: '2rem', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '1.5rem' }}>
                      {aiResult.insights.map((insight: string, idx: number) => (
                        <div key={idx} style={{ 
                          ...
                          <BrainCircuit size={20} color="var(--primary)" style={{ flexShrink: 0 }} />
